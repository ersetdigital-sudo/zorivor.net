// SVG icon set for admin sidebar (24x24, currentColor)
...
export function IconGamepad(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M6 8h12a4 4 0 0 1 4 4v2a4 4 0 0 1-4 4 3 3 0 0 1-2.8-2H8.8A3 3 0 0 1 6 18a4 4 0 0 1-4-4v-2a4 4 0 0 1 4-4z" />
